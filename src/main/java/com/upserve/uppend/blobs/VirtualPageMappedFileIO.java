...
public class VirtualPageMappedFileIO {
    ...
    VirtualPageMappedFileIO(int virtualFileNumber, VirtualPageFile virtualPageFile) {
    ...
    private int writeMappedOffset(long pos, byte[] bytes, int offset) {
        ...
        FilePage filePage = virtualPageFile.getFilePage(virtualFileNumber, pageNumber);

        int bytesWritten;
        bytesWritten = filePage.put(virtualPageFile.pagePosition(pos), bytes, offset);
    ...
    private int readMappedOffset(long pos, byte[] buf, int offset) {
        ...
        int bytesRead;
        bytesRead = filePage.get(virtualPageFile.pagePosition(pos), buf, offset);
